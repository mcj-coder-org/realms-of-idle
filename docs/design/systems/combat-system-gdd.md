...
## 11. Combat UI Mockups

### 11.1 Spectator Mode UI

```
┌─────────────────────────────────────────────────────────────────┐
│  IDLE WORLD - Combat (Spectator Mode)              [Pause] [×]  │
├─────────────────────────────────────────────────────────────────┤
│                                                                   │
│  ┌─────────────────────────────────────────────────────────────┐ │
│  │  COMBAT LOG                                    Auto-scroll │ │
│  ├─────────────────────────────────────────────────────────────┤ │
│  │  [14:32:05] Marcus (Warrior) attacks Goblin Spearman        │ │
│  │             → 28 damage (physical)                          │ │
│  │  [14:32:07] Goblin Spearman attacks Marcus                   │ │
│  │             → 12 damage blocked by shield (18/30)           │ │
│  │  [14:32:09] Elena (Mage) casts [Fireball]                   │ │
│  │             → 45 fire damage to 3 enemies!                  │ │
│  │  [14:32:11] Goblin Shaman heals Goblin Warrior              │ │
│  │             → +25 HP restored                               │ │
│  └─────────────────────────────────────────────────────────────┘ │
│                                                                   │
│  ┌─────────────────────┐    ┌─────────────────────────────────┐ │
...
│  ├─────────────────────┤    ├─────────────────────────────────┤ │
│  │ [🛡️] Marcus 85/120 │    │ [⚔️] Goblin Warrior 45/60      │ │
│  │ [🔥] Elena  60/80  │    │ [⚔️] Goblin Spearman 22/50      │ │
│  │ [💚] Kira   70/90  │    │ [📜] Goblin Shaman 35/45        │ │
│  │ [⚔️] Toren  55/75  │    │                                 │ │
│  └─────────────────────┘    └─────────────────────────────────┘ │
│                                                                   │
│  [Possess Marcus] [Possess Elena] [Possess Kira] [Possess Toren] │
│                                                                   │
│  Combat Time: 00:45  │  Tick: 23  │  Status: Fighting           │
└─────────────────────────────────────────────────────────────────┘
```

### 11.2 Player Control Mode UI

```
┌─────────────────────────────────────────────────────────────────┐
│  IDLE WORLD - Combat (Direct Control)            [Exit Combat]   │
├─────────────────────────────────────────────────────────────────┤
│                                                                   │
│  ┌─────────────────────┐    ┌─────────────────────────────────┐ │
│  │   YOUR PARTY        │    │   ENEMY PARTY                  │ │
│  │ [🎮] Marcus 85/120 │    │ [⚔️] Goblin Warrior 45/60      │ │
│  │   🔥🔥🔥 (Active)  │    │ [⚔️] Goblin Spearman 22/50      │ │
│  │   STAM: 75/90      │    │ [📜] Goblin Shaman 35/45        │ │
│  ├─────────────────────┤    └─────────────────────────────────┘ │
│  │ [🔥] Elena  60/80  │                                         │
│  │   MANA: 45/70      │     ← FRONT ROW                        │
│  ├─────────────────────┤                                         │
│  │ [💚] Kira   70/90  │     ← BACK ROW                          │
│  │   STAM: 60/80      │                                         │
│  ├─────────────────────┤                                         │
...
│  └─────────────────────┘                                         │
│                                                                   │
│  QUICK SKILLS (Marcus)                   ORDER PARTY             │
│  ┌─────────┬─────────┬─────────┬─────────┬─────────┐          [1] All: │
│  │[1] Power│[2]Shield│[3]Whirlwind│[4]Charge│[5]Potion│   Attack      │
│  │   Strike│   Bash  │          │         │         │   [2] Elena:  │
│  │   15stam│   10stam│  25stam  │  8stam   │   0stam  │   Cast Fireball│
│  │  READY  │  2.3s   │  READY   │  1.1s    │  READY   │   [3] Kira:   │
│  └─────────┴─────────┴─────────┴─────────┴─────────┘   Heal Toren  │
│                                                                  │
│  [Target: Goblin Warrior] ← [Next Target] [Lowest HP]          │
│                                                                  │
│  STATUS EFFECTS: (none)                                         │
│                                                                   │
│  [Pause] [Resume] [Combat Speed: ▮▮▮▯▯] [Flee] [Surrender]      │
└─────────────────────────────────────────────────────────────────┘
```

### 11.3 Multiplayer Turn-Based UI
...
### Reference Project (Cozy Fantasy RPG)

Combat system heavily inspired by and adapted from:

- [Attributes System](https://github.com/reference/cozy-fantasy-rpg/systems/character/attributes.md)
- [Combat Resolution](https://github.com/reference/cozy-fantasy-rpg/systems/combat/combat-resolution.md)
- [Armor Systems](https://github.com/reference/cozy-fantasy-rpg/content/systems/combat/armor-systems.md)
- [Weapons Systems](https://github.com/reference/cozy-fantasy-rpg/content/systems/combat/weapons-systems.md)
