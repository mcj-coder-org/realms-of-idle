...
Skills focused on resource collection, node detection, and sustainable harvesting. These skills excel in finding and efficiently gathering materials from the environment.

**Synergy Classes**: Forager, Miner, Hunter, Fisher, Lumberjack, Trapper, Herbalist
