---
title: 'Coastal Lizardfolk'
type: 'race-variant'
parent: 'Lizardfolk'
category: 'enlightened'
tier: 'ancient'
summary: 'Maritime-adapted lizardfolk who excel at sailing and oceanic trade'
---
...
Coastlines, islands, and shallow oceanic shelves where land and sea interact. Coastal lizardfolk cities feature extensive harbor facilities, ships designed for lizardfolk crew (more open to sun, with basking platforms), and architecture that accommodates both surface and underwater access. They favor warm coastal waters where sun exposure remains consistent.

## Magic Affinity

**Primary Schools:** Water, Weather

Coastal Lizardfolk excel at magic that masters maritime conditions - controlling currents, predicting storms, ensuring safe passage through dangerous waters. Their water magic emphasizes movement and navigation over the stillness of swamp variants. Weather magic helps them read atmospheric conditions and protect ships from storms that would devastate conventional vessels.
...
`Nature`, `Physical/Endurance`, `Combat`, `Gathering/Fishing`, `Physical/Strength`, `Trade`

Coastal Lizardfolk receive **3 random skills** from their racial skill pool at character creation, with additional skills available at racial milestone levels (10, 25, 50). Skills must match at least one of the pool tags above.
...
**[Deep Sea Swimming](../../../skills/index.md)**: Enhanced aquatic adaptation grants coastal lizardfolk exceptional swimming speed (+100% compared to baseline) and resistance to water pressure. They can dive to significant depths and maintain speed even in strong currents. This makes them natural sailors and underwater explorers.

**[Hold Breath](../../../skills/racial/index.md)**: Extended breath-holding capacity (measured in hours) allows coastal lizardfolk to perform underwater maintenance on ships, explore coastal caves, or conduct salvage operations without needing to surface frequently.

**[Salt Tolerance](../../../skills/racial/index.md)**: Adapted specifically to saltwater environments, coastal lizardfolk suffer no penalties from ocean water and resist dehydration better than other variants. They can drink brackish water if needed and handle long voyages without the constant fresh water needs of warm-blooded sailors.

**[Weather Sense](../../../skills/common/index.md)**: Generations of maritime experience have taught coastal lizardfolk to read atmospheric signs with uncanny accuracy. They predict weather changes, identify approaching storms, and understand seasonal patterns - knowledge crucial for safe navigation and profitable [trade](../../../systems/economy/index.md).

## Special Traits

| Trait             | Value                                                                |
| ----------------- | -------------------------------------------------------------------- |
| Enhanced Trait    | Deep Sea Swimming (superior aquatic movement and diving)             |
| Magic Focus       | Water and Weather schools, maritime emphasis                         |
| Environment       | Coastlines, islands, shallow ocean                                   |
| Cultural Emphasis | Navigation, maritime trade, ship building, weather prediction        |
| Trade Specialty   | Nautical goods, salvaged treasures, exotic fish, navigation services |
| Social Standing   | Most outgoing variant, bridge between lizardfolk and other races     |
...
Coastal lizardfolk maintain ancestor consultation but with maritime focus. Mummified elders rest in coastal temples, offering guidance about navigation, trade negotiations, and weather interpretation. Their wisdom spans centuries of maritime experience, making them invaluable for planning long voyages or establishing new trade routes.
...
Coastal Lizardfolk excel at maritime-focused classes that leverage their aquatic mastery and trading expertise:

- **[Sailor](../../../classes/index.md)**: Natural fit for their maritime environment and enhanced swimming
- **[Water Mage](../../../classes/magic/index.md)**: Leverages oceanic magic affinity and weather control
- **[Merchant](../../../classes/trade/index.md)**: Benefits from their trading experience and patient negotiation
- **[Navigator](../../../classes/index.md)**: Perfect for their weather sense and astronomical knowledge
- **[Fisherman](../../../classes/gathering/index.md)**: Exceptional at oceanic resource gathering
- **[Ship Builder](../../../classes/crafting/index.md)**: Traditional expertise in maritime construction

Less suitable for landlocked roles or fast-paced social situations, though coastal lizardfolk [Traders](../../../classes/trade/index.md) who've learned to adapt to warm-blooded pace can be surprisingly effective merchants.
