---
title: Appraise
gdd_ref: systems/action-system-gdd.md#trade-actions
domain: trade
ui_trigger: context-menu
base_duration: 5-20 seconds
---
...
**Base Duration**: 5-20 seconds

## Description

Determine item value and authenticity
...
Skills in the trade domain may modify speed, quality, or success rate.
...
Actions in the trade domain often work together or follow sequences.
