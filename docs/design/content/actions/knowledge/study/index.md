---
title: Study
gdd_ref: systems/action-system-gdd.md#knowledge-actions
domain: knowledge
ui_trigger: button
base_duration: 30-180 seconds
---
...
**Domain**: Knowledge
**UI Trigger**: button
**Base Duration**: 30-180 seconds

## Description

Read books or documents for information
...
Skills in the knowledge domain may modify speed, quality, or success rate.
...
Actions in the knowledge domain often work together or follow sequences.
