---
title: Craft
gdd_ref: systems/action-system-gdd.md#crafting-actions
domain: crafting
ui_trigger: button
base_duration: 10-120 seconds
---
...
**Domain**: Crafting
**UI Trigger**: button
**Base Duration**: 10-120 seconds

## Description

Create items from raw or processed materials
...
Skills in the crafting domain may modify speed, quality, or success rate.
...
Actions in the crafting domain often work together or follow sequences.
